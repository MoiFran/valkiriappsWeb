...
export interface ThreadsProps {
  ...
  /**
   * Enable mouse interaction with threads
   * @default false
   */
...
const Threads: React.FC<ThreadsProps> = ({
  ...
  useEffect(() => {
    ...
    if (!gl) {
      console.warn("WebGL not supported, Threads effect disabled");
      return;
    }
    ...
    // Optimized update loop with delta time
    let lastTime = 0;
    const targetFPS = 60;
  ...
  return (
    <div
      ...
      aria-label="Animated threads effect"
    />
  );
};
